...
Inventory.prototype.save = function () {
  ...
  if (!fs.existsSync(__dirname + '/../public/save/' + this.username)) fs.mkdirSync(__dirname + '/../public/save/' + this.username);
  jsf.writeFileSync(__dirname + '/../public/save/' + this.username + '/inventory-candy.json', this.data.candy, {spaces: 2});
  jsf.writeFileSync(__dirname + '/../public/save/' + this.username + '/inventory-pokemon.json', formatted, {spaces: 2});
};
